...
import static arbace.math.BigInteger.LONG_MASK;
...
public class BigInteger extends Number implements Comparable<BigInteger>
{
    ...
    public BigInteger(int bitLength, int certainty, Random rnd)
    {
        ...
        BigInteger prime = (bitLength < SMALL_PRIME_THRESHOLD) ? smallPrime(bitLength, certainty, rnd) : largePrime(bitLength, certainty, rnd);
        signum = 1;
        mag = prime.mag;
    }
     ...
     * @throws ArithmeticException {@code m} &le; 0 or the exponent is negative
     ...
     * Returns {@code true} if this BigInteger is probably prime,
     * {@code false} if it's definitely composite.
     * If {@code certainty} is &le; 0, {@code true} is returned.
     *
     * @param  certainty a measure of the uncertainty that the caller is
     *         willing to tolerate: if the call returns {@code true}
     *         the probability that this BigInteger is prime exceeds
    ...
    private static void toString(BigInteger u, StringBuilder sb, int radix, int digits)
    {
        ...
        if (u.mag.length <= SCHOENHAGE_BASE_CONVERSION_THRESHOLD)
        {
            ...
            {
                for (int i = s.length(); i < digits; i++) // May be a faster way to do this?
                {
                    sb.append('0');
                }
            }
     ...
     * <cite>The Java&trade; Language Specification</cite>: if this BigInteger
