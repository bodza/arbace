...
public class Spp {
    public static void main(String args[]) throws Exception {
        ...
        new Spp().spp(new Scanner(System.in), out, "", keys, vars, be, el, false);
    ...
    void append(StringBuffer buf, String ln, Set<String> keys, Map<String, String> vars) {
        vardef.reset(ln);
        while (vardef.find()) {
            String repl = "";
    ...
    boolean spp(Scanner in, StringBuffer buf, String key, Set<String> keys, Map<String, String> vars, boolean be, boolean el, boolean skip) {
