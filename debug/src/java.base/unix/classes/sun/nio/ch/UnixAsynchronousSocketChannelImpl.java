...
class UnixAsynchronousSocketChannelImpl extends AsynchronousSocketChannelImpl implements Port.PollableChannel {
    ...
    private static final boolean disableSynchronousRead = false; // "sun.nio.ch.disableSynchronousRead"

    private final Port port;
    private final int fdVal;

    // used to ensure that the context for I/O operations that complete
    // asynchronously is visible to the pooled threads handling I/O events
