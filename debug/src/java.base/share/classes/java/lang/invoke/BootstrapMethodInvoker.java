...
final class BootstrapMethodInvoker {
    ...
    static <T> T invoke(Class<T> resultType,
        ...
        if (vmIsPushing) {
            ...
            pullModeBSM = pullMode ? bootstrapMethod : pushMePullYou(bootstrapMethod, false);
        ...
        try {
            ...
            if (info == null) {
                ...
                if (isStringConcatFactoryBSM(bootstrapMethod.type())) {
                    result = (CallSite)bootstrapMethod.invokeExact(caller, name, (MethodType)type, (String)info, new Object[0]);
                } else {
                ...
                BootstrapCallInfo<Object> bsci = new VM_BSCI<>(bootstrapMethod, name, type, caller, (int[])info);
                ...
                if (isLambdaMetafactoryIndyBSM(bsmType) && argv.length == 3) {
                    result = (CallSite)bootstrapMethod.invokeExact(caller, name, (MethodType)type, (MethodType)argv[0], (MethodHandle)argv[1], (MethodType)argv[2]);
    ...
    private static Object invoke(MethodHandle bootstrapMethod, Lookup caller, String name, Object type) throws Throwable {
    ...
    private static Object invoke(MethodHandle bootstrapMethod, Lookup caller, String name, Object type, Object arg0) throws Throwable {
        if (type instanceof Class) {
    ...
    private static Object invoke(MethodHandle bootstrapMethod, Lookup caller, String name, Object type, Object arg0, Object arg1) throws Throwable {
        if (type instanceof Class) {
    ...
    private static Object invoke(MethodHandle bootstrapMethod, Lookup caller, String name, Object type, Object arg0, Object arg1, Object arg2) throws Throwable {
        if (type instanceof Class) {
    ...
    private static Object invoke(MethodHandle bootstrapMethod, Lookup caller, String name, Object type, Object arg0, Object arg1, Object arg2, Object arg3) throws Throwable {
        if (type instanceof Class) {
    ...
    private static Object invoke(MethodHandle bootstrapMethod, Lookup caller, String name, Object type, Object arg0, Object arg1, Object arg2, Object arg3, Object arg4) throws Throwable {
        if (type instanceof Class) {
    ...
    private static Object invoke(MethodHandle bootstrapMethod, Lookup caller, String name, Object type, Object arg0, Object arg1, Object arg2, Object arg3, Object arg4, Object arg5) throws Throwable {
        if (type instanceof Class) {
    ...
    private static Object invokeWithManyArguments(MethodHandle bootstrapMethod, Lookup caller, String name, Object type, Object[] argv) throws Throwable {
    ...
    /**
     * @return true iff the BSM method type exactly matches
     *         {@see java.lang.invoke.LambdaMetafactory#metafactory(MethodHandles.Lookup,String,Class,MethodType,MethodHandle,MethodType)}
     */
    ...
    /**
     * @return true iff the BSM method type exactly matches
     *         {@see java.lang.invoke.LambdaMetafactory#altMetafactory(MethodHandles.Lookup,String,MethodType,Object[])}
     */
    ...
    private static final class VM_BSCI<T> extends BSCIWithCache<T> {
        ...
        VM_BSCI(MethodHandle bsm, String name, T type, Lookup lookup, int[] indexInfo) {
        ...
        @Override public int copyConstants(int start, int end, Object[] buf, int pos) {
            ...
            copyOutBootstrapArguments(caller, indexInfo, i, end, temp, 0, true, null);
            for (Object x : temp) {
                x = maybeReBox(x);
                buf[bufi++] = x;
                cache[i++] = wrapNull(x);
        ...
        private void prefetchIntoCache(int i, int pfLimit) {
            ...
            copyOutBootstrapArguments(caller, indexInfo, i, pfLimit, temp, 0, false, NOT_PRESENT);
            for (Object x : temp) {
    ...
    class PushAdapter {
        ...
        static {
            ...
            try {
                MH_pushToBootstrapMethod = IMPL_LOOKUP.findStatic(THIS_CLASS, "pushToBootstrapMethod", MethodType.methodType(Object.class, MethodHandle.class, Lookup.class, String.class, Object.class, Object[].class));
            } catch (Throwable ex) {
    ...
    class PullAdapter {
        ...
        static {
            ...
            try {
                MH_pullFromBootstrapMethod = IMPL_LOOKUP.findStatic(THIS_CLASS, "pullFromBootstrapMethod", MethodType.methodType(Object.class, MethodHandle.class, Lookup.class, BootstrapCallInfo.class));
            } catch (Throwable ex) {
                throw new InternalError(ex);
            }
        }
