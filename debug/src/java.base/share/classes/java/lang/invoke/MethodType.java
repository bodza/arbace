...
public final class MethodType {
    ...
    private static final @Stable Class<?>[] METHOD_HANDLE_ARRAY = new Class<?>[] { MethodHandle.class };
    ...
    static boolean canConvert(Class<?> src, Class<?> dst) {
        ...
        if (src.isPrimitive()) {
            ...
            // An marginal case is Number -> dw:Character -> char, which would be OK if there
            // were a subclass of Number which wraps a value that can convert to char.
    ...
    private static class OffsetHolder {
        static final long rtypeOffset = UNSAFE.objectFieldOffset(MethodType.class, "rtype");

        static final long ptypesOffset = UNSAFE.objectFieldOffset(MethodType.class, "ptypes");
    }
