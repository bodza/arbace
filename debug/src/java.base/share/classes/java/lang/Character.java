 ...
 * </ul>
 *
 * In the Java SE API documentation, <em>Unicode code point</em> is
...
public final class Character implements Comparable<Character> {
    ...
    public static boolean isLowerCase(int codePoint) {
        return CharacterData.of(codePoint).isLowerCase(codePoint) || CharacterData.of(codePoint).isOtherLowercase(codePoint);
    }
    ...
    public static boolean isUpperCase(int codePoint) {
        return CharacterData.of(codePoint).isUpperCase(codePoint) || CharacterData.of(codePoint).isOtherUppercase(codePoint);
    }
    ...
    public static int codePointOf(String name) {
        ...
        int cp = -1/* oops! CharacterName.getInstance().getCodePoint(name) */;
        if (cp != -1)
            return cp;
        try {
