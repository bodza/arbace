...
public final class FileDescriptor {
    /* oops! private*/public int fd;

    /* oops! private*/public long handle;
     ...
     */
    /* oops! private */public boolean append;
    ...
    /* oops! */public synchronized void set(int fd) {
     ...
     */
    @SuppressWarnings("unchecked")
    /* oops! */public synchronized void registerCleanup(PhantomCleanable<FileDescriptor> cleanable) {
     ...
     */
    /* oops! */public synchronized void unregisterCleanup() {
        if (cleanup != null) {
            cleanup.clear();
        }
        cleanup = null;
     ...
     */
    @SuppressWarnings("unchecked")
    /* oops! */public synchronized void close() throws IOException {
        unregisterCleanup();
        close0();
    }
