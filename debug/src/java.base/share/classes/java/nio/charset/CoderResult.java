 ...
 *   isOverflow} method returns {@code true}.</li>
 *
 ...
 *   all malformed-input errors of a given length.</li>
 *
 ...
 *   of this class for all unmappable-character errors of a given length.</li>
 * </ul>
 *
 * For convenience, the {@link #isError() isError} method returns {@code true}
