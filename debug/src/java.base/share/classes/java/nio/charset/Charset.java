 ...
 *
 * <ul>
 *   <li>The uppercase letters {@code 'A'} through {@code 'Z'} (<code>'&#92;u0041'</code>&nbsp;through&nbsp;<code>'&#92;u005a'</code>),
 *   <li>The lowercase letters {@code 'a'} through {@code 'z'} (<code>'&#92;u0061'</code>&nbsp;through&nbsp;<code>'&#92;u007a'</code>),
 *   <li>The digits {@code '0'} through {@code '9'} (<code>'&#92;u0030'</code>&nbsp;through&nbsp;<code>'&#92;u0039'</code>),
 *   <li>The dash character {@code '-'} (<code>'&#92;u002d'</code>,&nbsp;<small>HYPHEN-MINUS</small>),
 *   <li>The plus character {@code '+'} (<code>'&#92;u002b'</code>,&nbsp;<small>PLUS SIGN</small>),
 *   <li>The period character {@code '.'} (<code>'&#92;u002e'</code>,&nbsp;<small>FULL STOP</small>),
 *   <li>The colon character {@code ':'} (<code>'&#92;u003a'</code>,&nbsp;<small>COLON</small>), and
 *   <li>The underscore character {@code '_'} (<code>'&#92;u005f'</code>,&nbsp;<small>LOW&nbsp;LINE</small>).
 * </ul>
 *
 ...
 * method.
 *
 * <a id="hn">Some charsets have an <i>historical name</i> that is defined for
 ...
 *
 * <a id="iana"> </a>If a charset listed in the <a
 ...
 *
 * <a id="standard">Every implementation of the Java platform is required to support the
 ...
 * </table></blockquote>
 *
 * The {@code UTF-8} charset is specified by <a
 ...
 * Standard</i></a>.
 *
 * The {@code UTF-16} charsets are specified by <a
 ...
 *
 * <ul>
 *   <li>When decoding, the {@code UTF-16BE} and {@code UTF-16LE}
 *   charsets interpret the initial byte-order marks as a <small>ZERO-WIDTH
 *   NON-BREAKING SPACE</small>; when encoding, they do not write
 *   byte-order marks.</li>
 *
 *   <li>When decoding, the {@code UTF-16} charset interprets the
 *   byte-order mark at the beginning of the input stream to indicate the
 *   byte-order of the stream but defaults to big-endian if there is no
 *   byte-order mark; when encoding, it uses big-endian byte order and writes
 *   a big-endian byte-order mark.</li>
 * </ul>
 *
...
public abstract class Charset implements Comparable<Charset> {
    ...
    public static Charset defaultCharset() {
        if (defaultCharset == null) {
            synchronized (Charset.class) {
                String csn = "UTF-8"; // "file.encoding"
     ...
     * characters.
     *
     * An invocation of this method upon a charset {@code cs} returns the
