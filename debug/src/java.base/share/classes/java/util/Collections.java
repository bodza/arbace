...
public class Collections {
    ...
    private static class UnmodifiableMap<K,V> implements Map<K,V> {
        ...
        static class UnmodifiableEntrySet<K,V> extends UnmodifiableSet<Map.Entry<K,V>> {
            ...
            static <K, V> Consumer<Map.Entry<? extends K, ? extends V>> entryConsumer(Consumer<? super Entry<K, V>> action) {
                return new Consumer<>() {
                    public void accept(Map.Entry<? extends K, ? extends V> e) { action.accept(new UnmodifiableEntry<>(e)); }
                };
            }
     ...
     *
     * The returned collection does <i>not</i> pass the {@code hashCode}
...
/**
    ...
    static class CheckedList<E> extends CheckedCollection<E> implements List<E> {
        ...
        public void replaceAll(UnaryOperator<E> operator) {
            ...
            list.replaceAll(new UnaryOperator<>() {
                public E apply(E e) { return typeCheck(operator.apply(e)); }
            });
        }
    ...
    private static class CheckedMap<K,V> implements Map<K,V> {
        ...
        public V computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) {
            ...
            return m.computeIfAbsent(key, new Function<>() {
                public V apply(K k) {
        ...
        public V merge(K key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
            ...
            return m.merge(key, value, new BiFunction<>() {
     ...
     * This example illustrates the type-safe way to obtain an empty map:
     * <pre>
     *     {@code SortedMap<String, Date> s = Collections.emptySortedMap();}
     * </pre>
     *
     * @implNote Implementations of this method need not create a separate
     ...
     * This example illustrates the type-safe way to obtain an empty map:
     * <pre>
     *     {@code NavigableMap<String, Date> s = Collections.emptyNavigableMap();}
     * </pre>
     *
     * @implNote Implementations of this method need not create a separate
