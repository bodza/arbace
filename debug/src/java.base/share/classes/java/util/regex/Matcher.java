 ...
 *
 * <ul>
 *   <li>The {@link #matches matches} method attempts to match the entire
 *   input sequence against the pattern.</li>
 *
 *   <li>The {@link #lookingAt lookingAt} method attempts to match the
 *   input sequence, starting at the beginning, against the pattern.</li>
 *
 *   <li>The {@link #find find} method scans the input sequence looking
...
public final class Matcher implements MatchResult {
     ...
     *   the last character matched, plus one, that is, to {@link #end()}.</li>
     * </ol>
     *
     ...
     * {@code one dog two dogs in the yard} to the standard-output stream:
     *
     * <blockquote><pre>
     * Pattern p = Pattern.compile("cat");
     * Matcher m = p.matcher("one cat two cats in the yard");
     ...
     * expression would yield the string {@code "zzzcatzzzdogzzz"}.
     *
     * Invoking this method changes this matcher's state.  If the matcher
     * is to be used in further matching operations then it should first be
     * reset.
