 ...
 *
 * <b>This class is <i>not</i> a general-purpose {@code Map}
 ...
 * to detect bugs.</i>
 *
 * Implementation note: This is a simple <i>linear-probe</i> hash table,
 ...
 */
public class IdentityHashMap<K,V> extends AbstractMap<K,V> implements Map<K,V>, Cloneable {
    /**
     ...
     *
     * <b>The {@code equals} method of the returned set returns {@code true}
