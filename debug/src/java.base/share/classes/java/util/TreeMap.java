...
public class TreeMap<K,V> extends AbstractMap<K,V> implements NavigableMap<K,V>, Cloneable {
     ...
     * and/or values from iterator.  The two formats that this method accepts are:
     *
     ...
     */
    private void buildFromSorted(int size, Iterator<?> it, V defaultVal) throws java.io.IOException, ClassNotFoundException {
        this.size = size;
    ...
    private final Entry<K,V> buildFromSorted(int level, int lo, int hi, int redLevel, Iterator<?> it, V defaultVal) throws java.io.IOException, ClassNotFoundException {
         ...
         * indices to pull out of the iterator for current subtree.
