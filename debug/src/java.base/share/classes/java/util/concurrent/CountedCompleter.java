 ...
 * <b>Sample Usages.</b>
 *
 * <b>Parallel recursive decomposition.</b> CountedCompleters may
 ...
 *
 * <b>Searching.</b> A tree of CountedCompleters can search for a
 ...
 *
 * <b>Recording subtasks.</b> CountedCompleter tasks that combine
 ...
 *
 * <b>Completion Traversals</b>. If using {@code onCompletion} to
 ...
 * }}</pre>
 *
 * <b>Triggers.</b> Some CountedCompleters are themselves never
...
public abstract class CountedCompleter<T> extends ForkJoinTask<T> {
    ...
    public final int decrementPendingCountUnlessZero() {
        int c;
        do {} while ((c = pending) != 0 && !PENDING.weakCompareAndSet(this, c, c - 1));
        return c;
    }
    ...
    void internalPropagateException(Throwable ex) {
        CountedCompleter<?> a = this, s = a;
        while (a.onExceptionalCompletion(ex, s) && (a = (s = a).completer) != null && a.status >= 0 && isExceptionalStatus(a.recordExceptionalCompletion(ex)))
            ;
    }
