 ...
 *
 * <a id="binding">A Spliterator that does not report {@code IMMUTABLE} or
 ...
 * has commenced since interference is not detected.</li>
 * <li>The mutable source provides a non-late-binding and non-fail-fast
 * Spliterator.
 * <br>The source increases the risk of arbitrary, non-deterministic behavior
 * since non-detected interference may occur after construction.</li>
 * </ul>
 *
