...
final class Streams {
    ...
    static final class RangeIntSpliterator implements Spliterator.OfInt {
        ...
        public Spliterator.OfInt trySplit() {
            ...
            return size <= 1 ? null : new RangeIntSpliterator(from, from = from + splitPoint(size), 0); // left split always has a half-open range
        }
    ...
    static final class RangeLongSpliterator implements Spliterator.OfLong {
        ...
        public Spliterator.OfLong trySplit() {
            long size = estimateSize();
            return size <= 1 ? null : new RangeLongSpliterator(from, from = from + splitPoint(size), 0); // left split always has a half-open range
        }
