 ...
 * }</pre>
 *
 * Here we use {@code widgets}, a {@code Collection<Widget>},
 ...
 *     must be generated to revisit the same elements of the source.</li>
 * </ul>
 *
 ...
 *     {@link java.util.BitSet#stream()} and
 *     {@link java.util.regex.Pattern#splitAsStream(java.lang.CharSequence)}.</li>
 * </ul>
 *
 ...
 *
 * Terminal operations, such as {@code Stream.forEach} or
 ...
 *
 * Intermediate operations are further divided into <em>stateless</em>
 ...
 *
 * Further, some operations are deemed <em>short-circuiting</em> operations.
 ...
 *
 * Streams may or may not have a defined <em>encounter order</em>.  Whether
 ...
 *
 * The three aspects of {@code collect} -- supplier, accumulator, and
 ...
 *         = employees.stream().collect(Collectors.groupingBy(Employee::getDepartment, summingSalaries));
 * }</pre>
 *
 ...
 * }</pre>
 *
 * Here, equivalence generally means according to {@link java.lang.Object#equals(Object)}.
 ...
 *
 * The class {@link java.util.stream.StreamSupport} has a number of
