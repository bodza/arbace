...
final class Nodes {
     ...
     *
     * The count of the concatenated node is equal to the sum of the count
     ...
     *
     * The result may be a concatenated node, the input sole node if the size
    ...
    private static class ArrayNode<T> implements Node<T> {
        ...
        public String toString() {
            return "ArrayNode[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private static final class CollectionNode<T> implements Node<T> {
        ...
        @Override
        public String toString() {
            return "CollectionNode[" + c.size() + "][" + c + "]";
        }
    }
    ...
    static final class ConcNode<T> extends AbstractConcNode<T, Node<T>> implements Node<T> {
        ...
        public String toString() {
            if (count() < 32) {
                return "ConcNode[" + left + "." + right + "]";
            } else {
                return "ConcNode[size=" + count() + "]";
            }
        }
        ...
        private abstract static class OfPrimitive<E, T_CONS, T_ARR, T_SPLITR extends Spliterator.OfPrimitive<E, T_CONS, T_SPLITR>, T_NODE extends Node.OfPrimitive<E, T_CONS, T_ARR, T_SPLITR, T_NODE>> extends AbstractConcNode<E, T_NODE> implements Node.OfPrimitive<E, T_CONS, T_ARR, T_SPLITR, T_NODE> {
            ...
            public String toString() {
                if (count() < 32)
                    return this.getClass().getName() + "[" + left + "." + right + "]";
                else
                    return this.getClass().getName() + "[size=" + count() + "]";
            }
        }
    ...
    private static final class FixedNodeBuilder<T> extends ArrayNode<T> implements Node.Builder<T> {
        ...
        public Node<T> build() {
            if (curSize < array.length)
                throw new IllegalStateException("Current size " + curSize + " is less than fixed size " + array.length);
            return this;
        }
        ...
        public void accept(T t) {
            if (curSize < array.length) {
                ...
                throw new IllegalStateException("Accept exceeded fixed size of " + array.length);
            }
        }
        ...
        public void end() {
            if (curSize < array.length)
                throw new IllegalStateException("End size " + curSize + " is less than fixed size " + array.length);
        }

        @Override
        public String toString() {
            return "FixedNodeBuilder[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private static class IntArrayNode implements Node.OfInt {
        ...
        @Override
        public String toString() {
            return "IntArrayNode[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private static class LongArrayNode implements Node.OfLong {
        ...
        @Override
        public String toString() {
            return "LongArrayNode[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private static class DoubleArrayNode implements Node.OfDouble {
        ...
        @Override
        public String toString() {
            return "DoubleArrayNode[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private static final class IntFixedNodeBuilder extends IntArrayNode implements Node.Builder.OfInt {
        ...
        @Override
        public String toString() {
            return "IntFixedNodeBuilder[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private static final class LongFixedNodeBuilder extends LongArrayNode implements Node.Builder.OfLong {
        ...
        @Override
        public String toString() {
            return "LongFixedNodeBuilder[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private static final class DoubleFixedNodeBuilder extends DoubleArrayNode implements Node.Builder.OfDouble {
        ...
        @Override
        public String toString() {
            return "DoubleFixedNodeBuilder[" + (array.length - curSize) + "][" + Arrays.toString(array) + "]";
        }
    }
    ...
    private abstract static class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>, K extends SizedCollectorTask<P_IN, P_OUT, T_SINK, K>> extends CountedCompleter<Void> implements Sink<P_OUT> {
        ...
        SizedCollectorTask(K parent, Spliterator<P_IN> spliterator, long offset, long length, int arrayLength) {
            ...
            if (offset < 0 || length < 0 || (offset + length - 1 >= arrayLength)) {
                throw new IllegalArgumentException("offset and length interval [" + offset + ", " + offset + " + " + length + ") is not within array size interval [0, " + arrayLength + ")");
            }
        }
