 ...
 *
 * <i>Normalization</i> is the process of removing unnecessary {@code "."}
 ...
 *   slightly in terms of which characters are considered legal and illegal.</li>
 * </ul>
 *
 * These purposes are served in this class by three related operations:
 *
 * <ul>
 *   <li><a id="encode"></a> A character is <i>encoded</i> by replacing it
 ...
 *   set.)</i></li>
 *
 *   <li><a id="quote"></a> An illegal character is <i>quoted</i> simply by
 ...
 *   all necessary quotation but which may contain <i>other</i> characters.</li>
 *
...
public final class URI implements Comparable<URI> {
     ...
     *   ({@code '['} and {@code ']'}) then the square brackets are added.</li>
     *
     *   <li>If a port number is given then a colon character
     *   ({@code ':'}) is appended, followed by the port number in decimal.</li>
     *
     ...
     *   is not a <a href="#legal-chars">legal URI character</a> is quoted.</li>
     *
     ...
     * </blockquote>
     *
     * can be used to ensure that <i>u</i> always refers to a URI that, if
     ...
     *   <b><i>(Deviation from RFC&nbsp;2396)</i></b></li>
     * </ol>
     *
     ...
     *
     * <ul>
     *   <li>A domain name consisting of one or more <i>labels</i>
     ...
     *   Addressing Architecture</i></a>.</li>
     * </ul>
     *
     ...
     *
     * <ul>
     *   <li>Two URIs with different schemes are ordered according the
     *   ordering of their schemes, without regard to case.</li>
     *
     *   <li>A hierarchical URI is considered to be less than an opaque URI
     *   with an identical scheme.</li>
     *
     *   <li>Two opaque URIs with identical schemes are ordered according
     *   to the ordering of their scheme-specific parts.</li>
     *
     *   <li>Two opaque URIs with identical schemes and scheme-specific
     *   parts are ordered according to the ordering of their
     *   fragments.</li>
     *
     *   <li>Two hierarchical URIs with identical schemes are ordered
     *   according to the ordering of their authority components:
     *
     *   <ul>
     *     <li>If both authority components are server-based then the URIs
     ...
     *     their ports.</li>
     *
     *     <li>If one or both authority components are registry-based then
     *     the URIs are ordered according to the ordering of their authority
     *     components.</li>
     *   </ul></li>
     *
     *   <li>Finally, two hierarchical URIs with identical schemes and
     *   authority components are ordered according to the ordering of their
     *   paths; if their paths are identical then they are ordered according to
     *   the ordering of their queries; if the queries are identical then they
     *   are ordered according to the order of their fragments.</li>
     * </ul>
     *
     * This method satisfies the general contract of the {@link
     ...
     *
     * If this URI does not contain any characters in the <i>other</i>
