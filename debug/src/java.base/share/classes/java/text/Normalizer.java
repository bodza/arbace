...
/* oops! import sun.text.normalizer.NormalizerBase; */
...
public final class Normalizer {
   private Normalizer() {};
    ...
    public static String normalize(CharSequence src, Form form) {
        return /* oops! NormalizerBase.normalize(src.toString(), form) */src.toString();
    }
    ...
    public static boolean isNormalized(CharSequence src, Form form) {
        return /* oops! NormalizerBase.isNormalized(src.toString(), form) */true;
    }
}
