...
public final class Unsafe {
    ...
    public Class<?> defineClass(String name, byte[] b, int off, int len, ClassLoader loader) {
        ...
        return defineClass0(name, b, off, len, loader/* oops! , null */);
    }

    public native Class<?> defineClass0(String name, byte[] b, int off, int len, ClassLoader loader/* oops! , ProtectionDomain pd */);
