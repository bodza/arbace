...
class CompileTask : public CHeapObj<mtCompiler> {
 ...
 public:
  ...
  void initialize(int compile_id, const methodHandle& method, int comp_level, const methodHandle& hot_method, int hot_count, CompileTask::CompileReason compile_reason, bool is_blocking);
...
private:
  static void  print_impl(outputStream* st, Method* method, int compile_id, int comp_level, bool is_blocking = false,
...
public:
  ...
  static void  print(outputStream* st, const nmethod* nm, const char* msg = NULL, bool short_form = false, bool cr = true) {
    print_impl(st, nm->method(), nm->compile_id(), nm->comp_level(), /*is_blocking*/ false, msg, short_form, cr);
  }
