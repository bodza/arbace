...
#include CPU_HEADER(c1_FrameMap)
 ...
 public:
  ...
  bool location_for_sp_offset(ByteSize byte_offset_from_sp, Location::Type loc_type, Location* loc) const;
  ...
  static LIR_Opr caller_save_cpu_reg_at(int i) { return _caller_save_cpu_regs[i]; }
  static LIR_Opr caller_save_fpu_reg_at(int i) { return _caller_save_fpu_regs[i]; }
