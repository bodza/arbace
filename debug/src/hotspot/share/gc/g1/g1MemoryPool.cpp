...
G1MemoryPoolSuper::G1MemoryPoolSuper(G1CollectedHeap* g1h, const char* name, size_t init_size, size_t max_size, bool support_usage_threshold) :
  _g1mm(g1h->g1mm()), CollectedMemoryPool(name, init_size, max_size, support_usage_threshold) {
}

G1EdenPool::G1EdenPool(G1CollectedHeap* g1h) :
  G1MemoryPoolSuper(g1h, "G1 Eden Space",
...
G1SurvivorPool::G1SurvivorPool(G1CollectedHeap* g1h) :
  G1MemoryPoolSuper(g1h, "G1 Survivor Space",
...
G1OldGenPool::G1OldGenPool(G1CollectedHeap* g1h) :
  G1MemoryPoolSuper(g1h, "G1 Old Gen",
