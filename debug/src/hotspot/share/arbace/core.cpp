...
// (about #_"ILookup"
///     (defn #_"value" ILookup''valAt ([^clojure.lang.ILookup this, #_"key" key] (.valAt this, key)) ([^clojure.lang.ILookup this, #_"key" key, #_"value" not-found] (.valAt this, key, not-found)))
// )
// )
...
///                     #_"[byte]" :code (vector)
///                     #_"[jdk.vm.ci.code.site.Mark]" :marks (vector)
///                     #_"[jdk.vm.ci.code.site.Call]" :calls (vector)
///                 )
///             )
///         )
///     )
...
///     )
     ...
     */
///     (defn- #_"[jdk.vm.ci.code.site.Site]" Compiler'getSortedSites-1 [#_"Assembler" asm]
///         (vec
///             (sort
///                 (fn #_"int" [#_"jdk.vm.ci.code.site.Site" s1, #_"jdk.vm.ci.code.site.Site" s2]
///                     (let [
...
///     (def- #_"jdk.vm.ci.hotspot.HotSpotResolvedJavaMethod" n'method (CompilerToVM'asResolvedJavaMethod (Class''getDeclaredMethod (-/class (fn* [] nil)), "invoke")))

///     (defn #_"jdk.vm.ci.hotspot.HotSpotCompiledCode" Compiler'createCompiledCode-1 [#_"Assembler" asm]
///         (let [
///             #_"String" name (JavaMethod''getName n'method)
///             #_"byte[]" code! (-/byte-array (:code asm))
///             #_"int" codeSize (-/alength code!)
///             #_"jdk.vm.ci.code.site.Site[]" sites! (-/into-array jdk.vm.ci.code.site.Site (Compiler'getSortedSites-1 asm))
...
///     (defn #_"jdk.vm.ci.code.InstalledCode" Compiler'createInstalledCode-1 [#_"Assembler" asm]
///         (let [
///             #_"jdk.vm.ci.hotspot.HotSpotCompiledCode" compiledCode (Compiler'createCompiledCode-1 asm)
///             #_"String" name (HotSpotCompiledCode''getName compiledCode)
///             #_"jdk.vm.ci.hotspot.HotSpotNmethod" installedCode (HotSpotNmethod'new n'method, name, false)
